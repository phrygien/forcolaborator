...
<div class="row mb-4">
    ...
    @if($createPrix)
        @include('livewire.prix_oeufs.create')
    @endif

    @if($editPrix)
        @include('livewire.prix_oeufs.edit')
    @endif
    ...
    <div class="col-md-12 mb-3">
        <div class="card text-left">
            ...
            <div class="card-body">
                <h4 class="card-title mb-3">{{ __('Liste prix oeufs ') }}</h4>
                <p>
                    <button class="btn btn-primary btn-rounded" wire:click="formPrix" wire:loading.attr="disabled" wire:target="formPrix">
                        <span wire:loading.remove wire:target="formPrix">Créer prix oeuf</span>
                ...
                <div class="overlay">
                    ...
                    <div class="alert alert-warning text-center">
                        <strong class="text-black">Suppression prix oeuf !</strong>
                        <p class="text-black">Vous etes sure de supprimer le prix oeuf : {{$recordToDelete->pu }}?</p>
