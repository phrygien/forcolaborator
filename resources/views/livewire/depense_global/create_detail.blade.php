                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group mb-3">
                        ...
                        <select wire:model="id_depense_brut" class="form-control form-control-rounded">
                            ...
                            @foreach ($depense_globals as $depense_global)
                                <option value="{{ $depense_global->id }}">Date entrée: {{ $depense_global->date_entree}} - Montant brut : {{ $depense_global->montant_total }} - Qte brut : {{ $depense_global->qte }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 form-group mb-3">
                        ...
                        <input type="number" wire:model="qte_value" class="form-control form-control-rounded" id="firstName2" placeholder="">
                        @error('qte_value') 
                        <div class="alert alert-danger" role="alert">
                            {{ $message}}
                        </div>
