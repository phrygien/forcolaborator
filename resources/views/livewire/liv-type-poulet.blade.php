...
<div class="row mb-4">
    ...
    @if($createType)
        @include('livewire.type_poulets.create')
    @endif

    @if($editType)
        @include('livewire.type_poulets.edit')
    @endif
    ...
    <div class="col-md-12 mb-3">
        <div class="card text-left">
            ...
            <div class="card-body">
                <h4 class="card-title mb-3">{{ __('Liste type poulet ') }}</h4>
                <p>
                    <button class="btn btn-primary btn-rounded" wire:click="formType" wire:loading.attr="disabled" wire:target="formType">
                        <span wire:loading.remove wire:target="formType">Créer type poulet</span>
                ...
                <div class="overlay">
                    ...
                    <div class="alert alert-warning text-center">
                        <strong class="text-black">Suppression type poulet !</strong>
                        <p class="text-black">Vous etes sure de supprimer le type poulet : {{$recordToDelete->categorie }}?</p>
