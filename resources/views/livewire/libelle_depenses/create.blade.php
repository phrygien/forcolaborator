<div class="col-md-12">
    <div class="card mb-4">
        <div class="card-body">
            <div class="card-title mb-3">{{ __('Création libelle depense')}}</div>
            <form>
                <div class="row">
                    <div class="col-md-6 form-group mb-3">
                        <label for="firstName2">{{ __('Libelle depense')}}</label>
                        <input type="text" wire:model.defer="libelle" class="form-control form-control-rounded" id="firstName2" placeholder="">
                        @error('libelle') 
                    ...
                    <div class="col-md-12">
                        <button class="btn btn-primary btn-rounded mr-3" wire:click.prevent="saveLibelle()" wire:loading.attr="disabled" wire:target="saveLibelle()">
                            <span wire:loading.remove wire:target="saveLibelle"><i class="nav-icon i-Yes font-weight-bold"></i> Enregistrer</span>
                            <span wire:loading wire:target="saveLibelle">
