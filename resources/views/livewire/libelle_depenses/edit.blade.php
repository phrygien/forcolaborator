...
<div class="overlay">
    ...
    <div class="alert alert-warning text-center">
        <strong class="text-black">{{ __('Modification libelle depense')}} !</strong>
        ...
        <p class="text-center">
            ...
            <button class="btn btn-danger btn-rounded" wire:click.prevent="updateLibelle()">{{ __('Valider') }}</button>
        </p>
    </div>
    </div>
</div>
