...
<div class="row mb-4">
    ...
    @endif
    @if($createConstat)
        @include('livewire.constat_poulards.create')
    @endif

    @if($createSortieConstant)
    @include('livewire.constat_poulards.create_sortie_constat')
    @endif


    @if($editConstat)
        @include('livewire.constat_poulards.edit')
    @endif
            ...
            <h4 class="card-title mb-3">
                <p>
                    <button class="btn btn-primary btn-rounded" wire:click="formConstat" wire:loading.attr="disabled" wire:target="formConstat">
                        <span wire:loading.remove wire:target="formConstat">Créer constat poularde</span>
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="overlay">
                            ...
                            <div class="alert alert-warning text-center">
                                <strong class="text-black">Suppression constat poularde !</strong>
                                <p class="text-black">Vous etes sure de supprimer le constat poularde du : {{$recordToDelete->date_constat }}?</p>
                                <p class="text-center">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{  get_formatted_date($constat->updated_at, 'd - M - Y à H:s') }}</td>
                                        <td>
